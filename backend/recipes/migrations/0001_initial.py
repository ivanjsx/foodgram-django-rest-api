    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='date & time of instance creation')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='date & time of last instance modification')),
                ('name', models.CharField(help_text='Provide a name', max_length=256, verbose_name='name')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(help_text='Provide a set of ingredients it includes', related_name='recipes', through='recipes.Quantity', to='recipes.Ingredient', verbose_name='Set of ingredients'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
